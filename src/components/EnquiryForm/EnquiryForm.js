    ...
    <div className="bg-light-white flex flex-row flex-wrap py-10 justify-between items-center w-[80%] mx-auto xl:w-full xl:justify-center lg:gap-[30px] lg:flex-col">
      <div className="flex flex-col gap-[40px] justify-center items-center w-[634px] xl:w-[550px] lg:w-auto">
        ...
        <div className="flex flex-col gap-[20px]">
          <input
            type="text"
            className="p-4 placeholder:text-light-gray-2 leading-[120%] indent-8 shadow-md shadow-light-gray-2 !w-[464px] md:!w-[355px] sm:!w-[300px]"
          ...
          <textarea
            type="text"
            className="p-4 placeholder:text-light-gray-2 leading-[120%] shadow-md shadow-light-gray-2 !w-[464px] md:!w-[355px] sm:!w-[300px]"
