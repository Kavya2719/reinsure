  ...
  return (
    <div className="pt-[40px] pb-[80px] flex flex-col items-center gap-20 lg:pb-[40px] lg:gap-10">
      <div className="flex flex-row gap-36 flex-wrap xl:gap-0 lg:items-center lg:justify-center lg:gap-10">
        ...
        <div className="flex flex-col items-center justify-center w-[510px] xl:w-[415px] xl:gap-16 lg:gap-0 lg:w-[374px] sm:w-[355px] sm:gap-[10px]">
          <div className="flex flex-row justify-start mb-[-80px] ml-6 w-[510px] xl:mb-[0] xl:ml-4 xl:w-[415px] lg:mb-[-20px] lg:w-[374px] sm:w-[355px] sm:mb-0">
          ...
          <div className="flex flex-row justify-end w-[510px] xl:w-[415px] lg:w-[374px] sm:w-[355px]">
          ...
          <div className="flex flex-row justify-start mt-[-80px] w-[510px] xl:mt-[0] xl:w-[415px] lg:mt-[-20px] lg:w-[374px] sm:w-[355px] sm:mt-0">
