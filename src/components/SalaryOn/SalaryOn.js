        ...
        <div className="flex flex-col gap-20">
          <div className="flex flex-col gap-[60px]">
            ...
            <div className="flex flex-row">
              <input
                className="bg-white px-6 py-[10px] text-xl placeholder:text-xl placeholder:font-light placeholder:text-light-gray-2 flex items-center"
            ...
            return (
              <div className="object-cover h-[50px] 2-[110px] flex items-center">
                <img
                  ...
                  alt={brand.name}
                  key={index}
                  className="max-w-[110px] max-h-[50px]"
                />
              </div>
            );
          })}
